...
class LeccionScreenEjercicios extends StatefulWidget {
  final Habilidad habilidad;

  const LeccionScreenEjercicios({super.key, required this.habilidad});

  @override
  State<LeccionScreenEjercicios> createState() => _leccionState();
}

class _leccionState extends State<LeccionScreenEjercicios> {
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text("Nivel ${imprimir.dificultad}",style: TextStyle(fontSize: 15,color: Color.fromARGB(255, 97, 97, 97)),),
                                                  ),
                                                ],
                                              ),
                                            ):Container(),
                                            ...
                                            ElevatedButton(
                                              onPressed: () {
                                                if(stateF.usuario.esPsicologo){
                                                  ...
                                                  Navigator.push(
                                                    context,
                                                    MaterialPageRoute(builder: (context) =>  crearLecion2( titulo: titulo,descripcion: descripcion,dificultad: nivel,imagen: imagen,
...
class crearLecion2 extends StatelessWidget {
  crearLecion2({
    super.key,
               ...
               Container(
                  ...
                  child: ListView(
                    ...
                    /*BlocBuilder<PortadorImagenBloc, PortadorImagenState>(
                      ...
                      personajeTipo2(portadorImagenBloc: portadorImagenBloc, leccionBloc: leccionBloc, habilidad: habilidad),
...
class personajeTipo2 extends StatelessWidget {
  const personajeTipo2({
    super.key,
    required this.portadorImagenBloc,
    required this.leccionBloc,
    required this.habilidad,
                                                        ...
                                                        Container(
                                                                            ...
                                                                            child: GridView.count(
                                                                               physics: NeverScrollableScrollPhysics(),
                                                                                        ...
                                                                                        children: List.generate(state.fotosEjercicio.length, (index) {
                                                                                          final leccion = state.fotosEjercicio[index];
                                                                                              ...
                                                                                              if(state2.leccionCM.imagen==leccion){
                                                                                                return SizedBox(
                                                                                                    ...
                                                                                                    child: ElevatedButton(
                                                                                                        onPressed: () {
                                                                                                          //BlocProvider.of<CambiadorBloc>(context).add(cambiarToCardLeccion(leccion));
                                                                                                          print("INGRESO DE IMAGENNNNNNNNNNNNNNNNNNNNNNNN AQUI"+leccion);
